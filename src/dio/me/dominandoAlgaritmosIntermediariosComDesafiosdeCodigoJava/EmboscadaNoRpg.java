 ...
 * 
 * O dano causado ao jogador é calculado dessa forma: vidaDoJogador - (ataqueInimigo - (defesaDoJogador + dados))
 * 
 * O dano causado ao inimigo é calculado dessa forma: vidaDoInimigo - (ataqueDoJogador + dados)
 * 
